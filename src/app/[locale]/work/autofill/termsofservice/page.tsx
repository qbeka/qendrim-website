    ...
    >
      ...
      <Flex direction="column" gap="l">
        ...
        <Flex direction="column" gap="s">
          ...
          <Text>Your use of the Gmail Code Autofill Extension is also governed by our <a href="/work/autofill/privacypolicy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>, which outlines our data practices regarding information collected and processed by the Extension.</Text>
        </Flex>
