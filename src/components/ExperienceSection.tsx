          ...
          {experiences.map((exp, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                ...
                <span
                  className={`text-sm uppercase tracking-wide px-4 py-2 rounded mt-2 md:mt-0 ${
                    theme === '8bit'
              ...
              <div>
                ...
                {education.minor && (
                  <p
                    className={`text-sm mt-1 ${
                      theme === '8bit' ? 'text-amber/70 bit-8-small' : 'text-stone'
                    }`}
                  >
                    {education.minor}
                  </p>
                ...
                <p
                  className={`text-sm mt-2 ${
                    theme === '8bit' ? 'text-amber bit-8-small' : 'text-burgundy'
                  }`}
                >
