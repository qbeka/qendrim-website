        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              >
                {theme === '8bit' ? '[AI_ENTHUSIAST | COMPETITOR | BUILDER]' : 'AI enthusiast, Competitor, and Builder'}
              </p>
            </div>
            ...
            >
              <p className={theme === '8bit' ? 'leading-relaxed' : 'font-serif text-lg leading-relaxed'}>
                Hi! I'm Qendrim, a 2nd Year Computer Science student at the{' '}
                <span className={theme === '8bit' ? 'text-amber' : 'text-burgundy font-semibold'}>
                  University of Alberta
                </span>
                . I'm passionate about AI, competitive programming, and building cool stuff. I've won hackathons and case competitions, and I'm currently looking for opportunities to learn and grow.
              </p>
            </div>
